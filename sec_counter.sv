...
(
    ...
    assign inc = (count == set_count.MAX_COUNT-1); // 40 ns eq to 1 s // 49999999 this assumes a 50MHz clock cycle and measures a second using that number of cycles
